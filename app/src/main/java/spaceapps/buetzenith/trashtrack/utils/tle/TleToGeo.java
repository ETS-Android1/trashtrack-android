...
public class TleToGeo {
    ...
    public static Trajectory getPosition(Tle tle, long timestamp, LatLng latLng) {
        return getPosition(tle, new Date(timestamp), latLng);
    }

    public static Trajectory getPosition(Tle tle, Date date, LatLng latLng) {
